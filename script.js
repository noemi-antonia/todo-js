class Model {
  ...
  deleteTodo(todoId) {
    const indexOfTodo = this.todoList.findIndex(
  ...
  changeCheckedStatus(todoId) {
    ...
    this.todoList[indexOfTodo].checked = this.todoList[indexOfTodo].checked
      ? false
      : true;
...
class View {
  constructor() {
    ...
    this.header.innerHTML = today.toDateString();
